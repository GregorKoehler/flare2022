...
class ExperimentPlanner3D_residual_v21_bfnnUNet_11(ExperimentPlanner3D_residual_v21_bfnnUNet):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super().__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_bfnnUNet_11"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlans_bfnnUNet_fabresnet_11_plans_3D.pkl")
        self.preprocessor_name = 'Preprocessor3DBetterResampling_11'
