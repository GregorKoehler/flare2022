...
def main():
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=None,
        help="Will be inserted before trainer+plans identifier-folder."
    )
    parser.add_argument("--flare_mode", required=False, default=False, action="store_true",
                        help="Set this flag if you want to run the FLARE prediction mode. This will use the less memory-intense configs.")
    ...
    if args.output_folders is not None:
        model_folder_name = join(network_training_output_dir, model, task_name, *args.output_folders, trainer + "__" +
                              args.plans_identifier)
    else:
    ...
    predict_from_folder(model_folder_name, input_folder, output_folder, folds, save_npz, num_threads_preprocessing,
                        ...
                        overwrite_existing=overwrite_existing, mode=mode, overwrite_all_in_gpu=all_in_gpu,
                        mixed_precision=not args.disable_mixed_precision,
                        step_size=step_size, checkpoint_name=args.chk, segmentation_export_kwargs=segmentation_export_kwargs)
